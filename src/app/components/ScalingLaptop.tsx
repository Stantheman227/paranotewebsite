...
const ScalingLaptop = ({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute min-[1675px]:h-[982px] min-[1675px]:w-[1306px] min-[1500px]:h-[800px] min-[1500px]:w-[1064px] h-[700px] w-[931px] items-center justify-center flex pointer-events-none">
          <Image
